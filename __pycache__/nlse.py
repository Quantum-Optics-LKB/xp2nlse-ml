...
class NLSE:
    ...
    def out_field(
        ...
        if plot:
            ...
            plt.tight_layout()
            plt.savefig('/home/louis/LEON/DATA/Atoms/2024/PINNS2/CNN/plots/nlse.png')
        return A
