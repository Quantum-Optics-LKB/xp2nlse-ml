...
def lauch_training(
    ...
    for model_index in range(2, 6):
        ...
        for data_types_index in range(len(data_types)):
            ...
            # number_of_n2 x number_of_power x number_of_isat
            file = f'{path}/Es_w{resolution}_n2{number_of_n2}_isat{number_of_isat}_power{number_of_power}_amp_pha_pha_unwrap_all_extended.npy' 
